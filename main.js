...
async function startQuiz() {
    let Quiz_questions = await inquirer.prompt([
        ...
        },
        {
            name: "answer3",
            type: "checkbox",
            message: "Which tool is commonly used to compile TypeScript code into JavaScript?",
            choices: ["Node.js", "TypeScript Compiler (tsc)", "Microsoft"],
        },
    ]);
    if (Quiz_questions.answer1.includes("Kamran Tessori")) {
        console.log(chalk.bgYellowBright("Congratulations! You have selected the correct answer for question 1."));
    }
    else {
        console.log("Sorry, you have selected the wrong option for question 1.");
    }
    if (Quiz_questions.answer2.includes("programming language developed by Microsoft")) {
        console.log("Congratulations! You have selected the correct answer for question 2.");
    }
    else {
        console.log(chalk.bgRedBright("Sorry, you have selected the wrong option for question 2."));
    }
    if (Quiz_questions.answer3.includes("TypeScript Compiler (tsc)")) {
        console.log(chalk.bgYellowBright("Congratulations! You have selected the correct answer for question 3."));
    }
    else {
